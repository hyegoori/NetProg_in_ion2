...
class CloudLoginPage(QtWidgets.QDialog):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        ...
        self.sign_in_button.clicked.connect(lambda: cloud.LOGIN_MANAGER.instance.login(origin='cloud-login-popup'))
        ...
        cloud.LOGIN_MANAGER.instance.sig_login_done.connect(self._login_done)
        cloud.LOGIN_MANAGER.instance.sig_throttle_started.connect(self._login_throttle_started)
        cloud.LOGIN_MANAGER.instance.sig_throttle_finished.connect(self._login_throttle_finished)

    def _finished(self) -> None:
        """Cancel login process."""
        cloud.LOGIN_MANAGER.instance.sig_login_done.disconnect(self._login_done)
        cloud.LOGIN_MANAGER.instance.sig_throttle_started.disconnect(self._login_throttle_started)
        cloud.LOGIN_MANAGER.instance.sig_throttle_finished.disconnect(self._login_throttle_finished)
